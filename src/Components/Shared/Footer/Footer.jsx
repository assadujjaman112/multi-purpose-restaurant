...
const Footer = () => {
  return (
    <footer className="py-8 md:py-14 lg:py-28">
      <div className="flex max-w-[80%] mx-auto gap-10 border-[#99A9AD] border-b-2 pb-5 md:pb-8 lg:pb-14">
        <div className="flex-1">
          <img src="/src/assets/Images/logo.png" alt="" />
          <div>
            <p className="text-xl mt-5 lg:mt-7 text-[#99A9AD]">
        ...
        <div className="flex-1">
          ...
          <div className="text-xl   text-[#99A9AD] flex justify-between">
            <p>Monday - Friday</p>
            <p>09:00 - 22:00</p>
          </div>
          <div className="text-xl   text-[#99A9AD] flex justify-between">
        ...
        <div className="flex-1">
          ...
          <p className="text-xl text-[#99A9AD]">
          ...
          <div className="flex items-center mt-12">
            ...
            <p className="text-xl text-[#99A9AD] ml-3">
      ...
      <div className="mt-5 max-w-[80%] mx-auto flex justify-between">
        ...
        <div className="text-xl text-[#99A9AD] flex gap-6">
          <p className=" hover:text-[#FFDE9F] hover:cursor-pointer">Privacy Policy</p>
          <p className=" hover:text-[#FFDE9F] hover:cursor-pointer">Terms Of Use</p>
        </div>
      </div>
    </footer>
  );
