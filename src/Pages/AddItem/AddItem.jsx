...
const AddItem = () => {
  ...
  return (
    <div className="w-11/12 md:w-4/5 lg:w-3/5 mx-auto h-screen flex flex-col justify-center items-center ">
      <div className="w-full bg-[#212529] px-7 rounded-lg pb-6">
        ...
        <form onSubmit={handleAddItem}>
          ...
          <div className="flex flex-col md:flex-row gap-3 md:gap-8 w-full mb-2">
            <div className="flex flex-col w-full">
              <span className="font-elsie text-[#FFDE9F] pl-2 mb-1">Price</span>
              <input
                type="text"
                name="price"
                id=""
            ...
            <div className="flex flex-col w-full">
              ...
              >
                <option value="breakfast" className="pl-3 py-2 bg-[#212529]">
                  Breakfast
                </option>
